...
axs[0].plot(agent_actions[2], color='b', lw=2, label='sssum', marker='+')

#axs[0].plot(agent_opt, color='r', lw=2, linestyle='--', label='intell-opt')
#axs[0].plot(aloha_opt, color='b', lw=2, ls='--', label='aloha-opt')
#axs[0].plot(tdma_opt, color='g', lw=2, ls='--', label='tdma-opt')
#axs[0].plot(sum_opt, color='y', lw=1, ls='--', label='sum-opt')
