...
for i in range(1, 5):
	plt.figure(i)
	my_plot('rewards/agent_len1e5_M40_h6_q0.4_t10-3_%d.txt' % i,
		    'rewards/aloha_len1e5_M40_h6_q0.4_t10-3_%d.txt' % i,
		     'rewards/tdma_len1e5_M40_h6_q0.4_t10-3_%d.txt' % i, q=0.4)
plt.show()
